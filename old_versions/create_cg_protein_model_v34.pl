...
$casm = 0; # 1 = create calpha-scm, 0 = create calpha model only!
...
elsif(uc($final_pot) =~ m/BT/) {$miya = "/gpfs/group/epo2/default/software/shared_files/bt_contact_potential.dat"}
...
if($dihedral_go[$np] == 0) 
 {
 $file = "/gpfs/group/epo2/default/software/shared_files/karanicolas_dihe_parm.dat";
...
print OUT "NONBONDED NBXMOD 4 ATOM CDIEL SWITCH VATOM VDISTANCE VSWITCH -\n";
